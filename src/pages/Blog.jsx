...
import { getBlogById } from "../helpers/getBlogsById";
import { getBlogs } from "../helpers/getBlog";
...
const Blog = () => {
  ...
  useEffect(()=>{
    getBlogs().then((data)=>setBlogs(data)).catch((err)=>console.log(err))
  },[])
  ...
  return (
      <section>
        ...
        <nav className="p-5 border-b-2 flex gap-2 bg-purple-500 ">
          <Link to="/" className="font-semibold flex  justify-center items-center gap-2 text-gray-300 hover:text-white transition-all
        ...
        <div className="flex mx-5 gap-3 md:gap-5 flex-col md:flex-row">
          ...
          <div className="w-full md:w-[60vw] bg-white mx-auto p-5 rounded-lg my-10">
            ...
            <img src={blog.thumbnail} alt="blog's thumbnail" className="w-full h-[40vh] object-cover rounded-2xl
            shadow-md" />
            ...
            <hr/>
            <div className="my-5">
              <p className="overflow-x-clip" dangerouslySetInnerHTML={{ __html: blog.content }}></p>
            </div>
          ...
          <div className="my-10 ">
            ...
            {/* BLOG CONTENT*/}
            <h3 className="text-3xl font-semibold text-gray-600 ml-3 mt-10">Comments
            </h3>
              ...
              <div className="flex justify-between items-start gap-3 my-5 ">
                ...
                <div className="flex flex-col w-full gap-3">
                  ...
                  <div className="flex gap-3">
                    <button onClick={addComment} className="text-white bg-purple-500 hover:bg-purple-400 px-5 py-1 text-base
                    font-semibold transition-all duration-300 ease-linear rounded-md w-fit ">
                      Add
                    </button>
                    <button  className="text-white bg-purple-500 hover:bg-purple-400 px-5 py-1 text-base
                    font-semibold transition-all duration-300 ease-linear rounded-md w-fit" 
                    onClick={!UserAuthenticated? signInWithGoogle: signOutWithGoogle}>
              ...
              <div>
                ...
                ({ comment, userName, userImage, userId, _id }) => (
                  <div className="flex flex-col md:flex-row justify-start items-center md:gap-3 my-3" 
                    key={_id}
                    id="commentsDiv">
                      <img src={userImage} alt=""  className="rounded-full hiden md:block w-[50px] 
                      text-gray-600"/>
                      <div className="bg-white w-full md:w-[35vw] rounded-lg py-2 text-sm md:text-base px-3 
                      shadow-md">
